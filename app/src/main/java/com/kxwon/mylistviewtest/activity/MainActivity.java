package com.kxwon.mylistviewtest.activity;
...
import com.kxwon.mylistviewtest.R;
import com.kxwon.mylistviewtest.adapter.MyBaseAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            adapter = new CallSafeAdapter(blackNumberInfos, MainActivity.this);
    ...
    private void initData() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                dao = new BlackNumberDao(MainActivity.this);
                //通过总的记录数 / 每页多少条数据
    ...
    private class CallSafeAdapter extends MyBaseAdapter<BlackNumberInfo> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = View.inflate(MainActivity.this, R.layout.item_call_safe, null);
